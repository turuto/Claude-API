import { addUserMessage, chat, closeClient } from './partials/basicChat.js';
...
function buildPrompt(promptInputs) {
    return `What should I say back to this customer?
...
// Closes the Copilot CLI connection opened in basicChat.js — without this the process
// hangs after the report is written instead of exiting.
await closeClient();
process.exit(0);
